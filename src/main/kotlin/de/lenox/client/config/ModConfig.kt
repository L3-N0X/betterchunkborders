...
data class ModConfig(
    ...
    var lineColor: Color = Color(255, 255, 0, 255),
    var useSeparateCornerColor: Boolean = true,
    var cornerLineColor: Color = Color(255, 0, 255, 255),
    var lineWidth: Float = 1.0f,
    var renderGradients: Boolean = false,
    var gradientTopColor: Color = Color(255, 238, 0, 0),
    var gradientBottomColor: Color = Color(154, 156, 29, 117),
    var gradientMaxHeight: Float = 64.0f,
    var renderSurroundingBorders: Boolean = false,
    var surroundingBordersColor: Color = Color(59, 142, 115, 115),
    var useGradientLines: Boolean = false,
    var lineHeightAbovePlayer: Float = 1.0f,
    var lineHeightBelowPlayer: Float = 64.0f,
    var useTerrainHeightmap: Boolean = false,
    var slopeTerrainGradients: Boolean = true,
    var terrainGradientHeight: Float = 1.0f,
    var terrainLineHeight: Float = 12.0f,
    var renderLines: Boolean = true,
    var terrainAdaptionSteps: Int = 4,
    var gradientUndergroundColor: Color = Color(255, 248, 0, 15),
    var smoothTerrainHeight: Boolean = false,
    var limitLineHeight: Boolean = false,
    var smoothPlayerHeight: Boolean = false,
    var playerHeightSmoothingSpeed: Float = 5.0f,
    var renderHorizontalLines: Boolean = true,
    var horizontalLineColor: Color = Color(255, 255, 0, 255),
    var horizontalLineWidth: Float = 1.0f,
    var horizontalLineSpacing: Float = 2.0f,
    ...
    var smoothLineMovement: Boolean = false,
